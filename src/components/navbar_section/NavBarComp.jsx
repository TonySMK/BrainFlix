            ...
            <nav className="nav">
                <div className="nav__first">
                    <div className="mainlogo">
                        <img className="mainlogo__img" src={BrainflixLogo} alt="Brainflix Logo"/>
                        <a className="mainlogo__link" href="n/a">BrainFlix Logo</a>
                    </div>
                </div>
                ...
                <div className="nav__second">
                    <div className="searchcontainer">
                        <div className="searchcontainer__imgwarp">
                            <img className="searchcontainer__imgwarp__iconsearch" src={SearchIcon} alt="sdasd"/>
                        </div>
                        <input className="searchcontainer__inputtext" type="text"  
